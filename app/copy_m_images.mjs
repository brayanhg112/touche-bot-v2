...
const mSrcList = [
  'F:\\BRIAN\\ENTREGA INMEDIATA🫧\\CABALLERO🤵‍♂️',
  'F:\\BRIAN\\ENTREGA INMEDIATA\u{1FAB7}\\CABALLERO\u{1F935}\u{200D}\u{2642}\u{FE0F}'
];

for(const src of mSrcList) {
    if(fs.existsSync(src)) {
        console.log(`Found male source directory! ${src}`);
        copyDirWithTryCatch(src, 'm');
        break;
    }
}
